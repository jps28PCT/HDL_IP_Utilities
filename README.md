...
<details>
  ...
  It was made to be used with a 3-bit adder, but it is appropriate with any system needing to convert a 4-bit binary number to a two-digit decimal number.</br>
